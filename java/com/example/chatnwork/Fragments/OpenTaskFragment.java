...
public class OpenTaskFragment extends Fragment {
    ...
    private List<Task> opentask;


    public OpenTaskFragment() {
        // Required empty public constructor
    }
    public OpenTaskFragment( UserAccount current) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_open_task, container, false);
        recyclerView= v.findViewById(R.id.openrecycler);
    ...
    private void getOpenTask() {
        ...
        dref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new TaskAdapter(getContext(),opentask);
